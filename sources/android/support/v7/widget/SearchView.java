...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    private void getChildBoundsWithinSearchView(View view, Rect rect) {
        ...
        rect.set(i3, i2, i3 + view.getWidth(), i2 + view.getHeight());
    }
    ...
    boolean onSuggestionsKey(View view, int i2, KeyEvent keyEvent) {
        if (this.mSearchable != null && this.mSuggestionsAdapter != null) {
            if (keyEvent.getAction() == 0 && keyEvent.hasNoModifiers()) {
                ...
                if (i2 == 19 && 0 == this.mSearchSrcTextView.getListSelection()) {
                    return false;
                }
            }
            return false;
    ...
    private Intent createIntentFromSuggestion(Cursor cursor, int i2, String str) {
        ...
        try {
            ...
            Log.w(LOG_TAG, "Search suggestions cursor at row " + i3 + " returned exception.", e);
            return null;
        }
    }
