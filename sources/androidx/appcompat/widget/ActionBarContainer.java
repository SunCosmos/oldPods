...
public class ActionBarContainer extends FrameLayout {
    ...
    public void onFinishInflate() {
        ...
        this.f135c = findViewById(R.id.action_bar);
        this.f136d = findViewById(R.id.action_context_bar);
    }
    ...
    public void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        if (this.h) {
            ...
            if (this.e != null) {
                if (this.f135c.getVisibility() == 0) {
                    drawable2 = this.e;
                    left = this.f135c.getLeft();
                    top = this.f135c.getTop();
                    right = this.f135c.getRight();
                    view = this.f135c;
                } else {
                    View view3 = this.f136d;
                    if (view3 == null || view3.getVisibility() != 0) {
                        this.e.setBounds(0, 0, 0, 0);
                        z3 = true;
                    } else {
                        drawable2 = this.e;
                        left = this.f136d.getLeft();
                        top = this.f136d.getTop();
                        right = this.f136d.getRight();
                        view = this.f136d;
                    }
                }
    ...
    */
    ...
    public void setPrimaryBackground(Drawable drawable) {
        ...
        if (drawable != null) {
            ...
            if (view != null) {
                this.e.setBounds(view.getLeft(), this.f135c.getTop(), this.f135c.getRight(), this.f135c.getBottom());
            }
        }
        boolean z = true;
        if (!this.h ? this.e != null || this.f != null : this.g != null) {
    ...
    public void setStackedBackground(Drawable drawable) {
        ...
        if (drawable != null) {
            drawable.setCallback(this);
            if (this.f137i && (drawable2 = this.f) != null) {
    ...
    protected boolean verifyDrawable(Drawable drawable) {
        return (drawable == this.e && !this.h) || (drawable == this.f && this.f137i) || ((drawable == this.g && this.h) || super.verifyDrawable(drawable));
    }
}
