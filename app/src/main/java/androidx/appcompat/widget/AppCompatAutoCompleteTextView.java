...
public class AppCompatAutoCompleteTextView extends AutoCompleteTextView implements TintableBackgroundView {
    ...
    /* renamed from: c */
    private static final int[] f150c = {R.attr.popupBackground};
    private final b a;
    private final i b;
    ...
    public AppCompatAutoCompleteTextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getContext(), attributeSet, f150c, i2, 0);
