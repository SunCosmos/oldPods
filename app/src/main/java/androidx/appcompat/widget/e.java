...
class e {
    ...
    private static final int[] f214c = {R.attr.indeterminateDrawable, R.attr.progressDrawable};
    ...
    public void c(AttributeSet attributeSet, int i2) {
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(this.a.getContext(), attributeSet, f214c, i2, 0);
        Drawable drawableIfKnown = obtainStyledAttributes.getDrawableIfKnown(0);
        if (drawableIfKnown != null) {
            this.a.setIndeterminateDrawable(e(drawableIfKnown));
        }
        Drawable drawableIfKnown2 = obtainStyledAttributes.getDrawableIfKnown(1);
        if (drawableIfKnown2 != null) {
            this.a.setProgressDrawable(d(drawableIfKnown2, false));
        }
