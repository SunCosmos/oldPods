...
final class AppCompatColorStateListInflater {
            ...
            if (next == 2 && depth <= depth2 && xmlPullParser.getName().equals("item")) {
                ...
                for (int i4 = 0; i4 < attributeCount; i4++) {
                    ...
                    if (attributeNameResource != 16843173 && attributeNameResource != 16843551 && attributeNameResource != R.attr.alpha) {
                        int i5 = i3;
                        i3++;
                        iArr3[i5] = attributeSet.getAttributeBooleanValue(i4, false) ? attributeNameResource : -attributeNameResource;
                    }
                }
    ...
    private static int modulateColorAlpha(int i2, float f) {
        return ColorUtils.setAlphaComponent(i2, Math.round(Color.alpha(i2) * f));
    }
}
