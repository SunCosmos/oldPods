...
public class AlertController {
    ...
    private void setupView() {
        ...
        if (!z) {
            ...
            View view3 = view;
            if (view3 != null) {
                setScrollIndicators(resolvePanel2, view3, (z2 ? 1 : 0) | (z3 ? 2 : 0), 3);
            }
        }
        ...
        public void setHasDecor(boolean z, boolean z2) {
            ...
            if (!z2 || !z) {
                ...
                if (z2) {
                    ...
                    i3 = this.mPaddingBottomNoButtons;
                }
                setPadding(paddingLeft, i4, paddingRight, i3);
            }
        }
    }
    ...
    public static class AlertParams {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        /* JADX WARN: Type inference failed for: r5v17, types: [android.widget.ListAdapter] */
        private void createListView(final AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                checkedItemAdapter = this.mCursor == null ? new ArrayAdapter<CharSequence>(this.mContext, alertController.mMultiChoiceItemLayout, android.R.id.text1, this.mItems) { // from class: android.support.v7.app.AlertController.AlertParams.1
