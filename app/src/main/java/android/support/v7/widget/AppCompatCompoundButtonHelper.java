...
class AppCompatCompoundButtonHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i2) {
        int resourceId;
        TypedArray obtainStyledAttributes = this.mView.getContext().obtainStyledAttributes(attributeSet, R.styleable.CompoundButton, i2, 0);
        try {
    ...
    public int getCompoundPaddingLeft(int i2) {
        ...
        if (Build.VERSION.SDK_INT < 17 && (buttonDrawable = CompoundButtonCompat.getButtonDrawable(this.mView)) != null) {
            i3 += buttonDrawable.getIntrinsicWidth();
        }
        return i3;
    }
}
