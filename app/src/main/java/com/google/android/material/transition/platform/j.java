...
class j {
    ...
    static class b implements d {
        ...
        public CornerSize a(@NonNull CornerSize cornerSize, @NonNull CornerSize cornerSize2) {
            return new AbsoluteCornerSize(j.o(cornerSize.getCornerSize(this.a), cornerSize2.getCornerSize(this.b), this.f1813c, this.f1814d, this.e));
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static float o(float f, float f2, @FloatRange(from = 0.0d, to = 1.0d) float f3, @FloatRange(from = 0.0d, to = 1.0d) float f4, @FloatRange(from = 0.0d, to = 1.0d) float f5) {
        return p(f, f2, f3, f4, f5, false);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static float p(float f, float f2, @FloatRange(from = 0.0d, to = 1.0d) float f3, @FloatRange(from = 0.0d, to = 1.0d) float f4, @FloatRange(from = 0.0d) float f5, boolean z) {
        return (!z || (f5 >= 0.0f && f5 <= 1.0f)) ? f5 < f3 ? f : f5 > f4 ? f2 : n(f, f2, (f5 - f3) / (f4 - f3)) : n(f, f2, f5);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int q(int i2, int i3, @FloatRange(from = 0.0d, to = 1.0d) float f, @FloatRange(from = 0.0d, to = 1.0d) float f2, @FloatRange(from = 0.0d, to = 1.0d) float f3) {
        return f3 < f ? i2 : f3 > f2 ? i3 : (int) n(i2, i3, (f3 - f) / (f2 - f));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static ShapeAppearanceModel r(ShapeAppearanceModel shapeAppearanceModel, ShapeAppearanceModel shapeAppearanceModel2, RectF rectF, RectF rectF2, @FloatRange(from = 0.0d, to = 1.0d) float f, @FloatRange(from = 0.0d, to = 1.0d) float f2, @FloatRange(from = 0.0d, to = 1.0d) float f3) {
        return f3 < f ? shapeAppearanceModel : f3 > f2 ? shapeAppearanceModel2 : z(shapeAppearanceModel, shapeAppearanceModel2, rectF, new b(rectF, rectF2, f, f2, f3));
    }
    ...
    public static boolean t(Transition transition, Context context, @AttrRes int i2, TimeInterpolator timeInterpolator) {
        ...
        transition.setInterpolator(v(context, i2, timeInterpolator));
        return true;
    }
    ...
    static TimeInterpolator v(Context context, @AttrRes int i2, @NonNull TimeInterpolator timeInterpolator) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void y(Canvas canvas, Rect rect, float f, float f2, float f3, int i2, c cVar) {
        if (i2 <= 0) {
            return;
        }
